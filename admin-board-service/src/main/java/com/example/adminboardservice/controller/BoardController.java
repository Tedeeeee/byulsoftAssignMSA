...
public class BoardController {
    ...
    // 게시글 전체 가져오기
    @GetMapping
    public ResponseEntity<BodyResponse<BoardListResponseDto>> getAllBoards(@RequestParam(name = "searchText") String searchText,
    ...
    @GetMapping("/{boardId}")
    public ResponseEntity<BodyResponse<BoardResponseDto>> getBoardByBoardId(@PathVariable("boardId") int boardId) {
